...
enum Enum_IRCResponses
{
    ...
    Enum_IRCResponses_RPL_INVITING = 341,
    ...
    Enum_IRCResponses_ERR_UNKNOWNCOMMAND = 421,
    Enum_IRCResponses_ERR_NOMOTD = 422,
    ...
    Enum_IRCResponses_ERR_USERONCHANNEL = 443,
...
Begin_Enum_String(Enum_IRCResponses)
{
    ...
    Enum_String(Enum_IRCResponses_RPL_INVITING, "341");
    ...
    Enum_String(Enum_IRCResponses_ERR_UNKNOWNCOMMAND, "421");
    Enum_String(Enum_IRCResponses_ERR_NOMOTD, "422");
    ...
    Enum_String(Enum_IRCResponses_ERR_USERONCHANNEL, "443");
